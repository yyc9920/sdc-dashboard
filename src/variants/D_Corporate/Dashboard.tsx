...
export default function Dashboard() {
  ...
  return (
    <div className="h-full px-6 py-4 grid grid-cols-12 gap-3 overflow-hidden">
      <div className="col-span-12 flex items-end justify-between pb-2 border-b-2 border-burgundy-500">
        <div>
          <div className="text-[10px] tracking-[0.2em] text-burgundy-700 font-semibold">VARIANT D · CORPORATE EDITION</div>
          <div className="text-2xl font-bold">Students' Management Data <span className="text-slate-400 font-normal">· SDC Edu Solutions</span></div>
        </div>
      ...
      <aside className="col-span-4 card min-h-0 overflow-hidden flex flex-col">
      ...
      <section className="col-span-8 grid grid-cols-12 grid-rows-2 gap-3 min-h-0">
        <div className="col-span-8 card p-3 min-h-0 flex flex-col">
        ...
        <div className="col-span-4 card p-3 min-h-0 flex flex-col">
          <div className="text-[10px] tracking-[0.14em] text-burgundy-700 font-semibold">FIG. 1 · CLE RADAR</div>
          <div className="flex-1 min-h-0"><Radar current={cleAt(selected, cursor)} theme={radarTheme} /></div>
        </div>

        <div className="col-span-12 card p-3 min-h-0 flex flex-col">
          <div className="text-[10px] tracking-[0.14em] text-burgundy-700 font-semibold">FIG. 2 · CLASS ATTENDANCE % BY MONTH</div>
          <div className="flex-1 min-h-0"><ClassAttendanceBars /></div>
        </div>
      </section>
    </div>
  );
