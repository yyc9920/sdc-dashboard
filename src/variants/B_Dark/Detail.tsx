...
export default function Detail() {
  ...
  return (
    <div className="min-h-screen px-3 lg:px-6 py-3 lg:py-4 flex flex-col gap-3 lg:gap-4 lg:h-full lg:grid lg:grid-cols-12 lg:grid-rows-6 lg:overflow-hidden">
      <div className="card glow p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 lg:col-span-12 lg:row-span-1">
        <div>
          <div className="mono text-[10px] tracking-[0.2em] text-sky-300/80">KILLER · LIVE COHORT RANK</div>
          <div className="flex items-baseline gap-3 mt-0.5 flex-wrap">
            <div className="text-2xl sm:text-3xl font-black">{s.name}</div>
        ...
        <div className="flex items-center gap-5">
          <div className="text-right">
            ...
            <div className="mono text-2xl sm:text-3xl font-black grad">{rank}<span className="text-lg opacity-60">/{STUDENTS.length}</span></div>
          </div>
          <div className="text-right">
            <div className="mono text-[10px] opacity-60">PERCENTILE</div>
            <div className="mono text-2xl sm:text-3xl font-black">상위 {percentile}%</div>
          </div>
        </div>
      </div>
      ...
      <div className="card p-4 flex flex-col min-h-[300px] lg:min-h-0 lg:col-span-5 lg:row-span-3">
        ...
        <div className="h-[220px] lg:h-auto lg:flex-1 lg:min-h-0"><Radar current={cle} ghost={cohortCLE} theme={radarTheme} /></div>
      </div>
      ...
      {/* TOEFL */}
      <div className="card p-4 flex flex-col lg:col-span-4 lg:row-span-2">
      ...
      <div className="card p-4 flex flex-col gap-3 lg:col-span-4 lg:row-span-2">
      ...
      {/* Awards */}
      <div className="card p-4 flex flex-col lg:col-span-4 lg:row-span-2 lg:min-h-0">
        ...
        <div className="max-h-[200px] lg:max-h-none lg:flex-1 lg:min-h-0 overflow-auto space-y-1.5">
